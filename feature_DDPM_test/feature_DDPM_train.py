...
num_epochs = 50000
timesteps = 1000
base_save_dir = './training/01_BRCA_TP53_race_2024-06-07_15-05-26'
...
def train_model_for_folder(folder_name):
    train_folder = os.path.join(data_dir, folder_name)
...
for folder_name in subfolders:
    ...
    train_model_for_folder(folder_name)
    print(f"Finished training for folder: {folder_name}")